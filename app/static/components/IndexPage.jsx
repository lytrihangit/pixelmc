...
import { ContentsWrapper, Wrapper, Titlebar, Sidebar, BigStar, SmallStar } from "./SubComponents";
...
export default class Index extends React.Component {
	constructor(props) {
		...
		ipcRenderer.on(channels.game.mods, (e, msg) => {
			//console.log(msg);
			//ipcRenderer.send(channels.game.mods, "mods");
		...
		ipcRenderer.on(channels.download.response, (e, d) => {
			...
			if (d) {
				...
				btn.html("<h2>Bạn đang bắt đầu tải, vui lòng chờ!<h2/>");
				setTimeout(() => {
					this.isNoticing = false;
